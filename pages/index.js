...
export default function Home() {
  return (
    ...
    <div className='p-12' style={{fontFamily:'Musio Sans 500'}}>
     ...
     <h5 className='text-2xl font-bold font-roboto capitalize text-gray-300 mt-1' >Multi day course ?</h5>
...
<p className='ml-2 text-gray-300 font-bold'>467 total reviews for this teacher</p>
</div>
<div className='flex'>
<Rating name="read-only" value={5} readOnly />
<p className='text-gray-300 ml-2 font-bold'>5 reviews for this class</p>
</div>
<h2 className='font-bold mt-6 mb-6'>completed by 21 learners</h2>
<div className='flex justify-between mt-12'>
<button className='bg-blue-600 text-white  px-4 py-2 font-bold capitalize rounded-full'>see class schedule
